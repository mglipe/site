...
<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0/css/bootstrap.min.css" integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm" crossorigin="anonymous">
    ...
    <body>
		...
		<?
			if($_SERVER["REMOTE_ADDR"] == "179.95.180.117"){
				?>
				<div class="cookie-disclaimer">
				  <div class="cookie-close accept-cookie"><i class="fa fa-times"></i></div>
				  <div class="container">
					<p>Audiatur  <a href="#">Les mer om hvilke kapsler vi bruker</a>. 
					  <br>Ved å fortsette å bruke nettstedet, aksepterer du vår bruk av informasjonskaplser</p>
					<button type="button" class="btn btn-success accept-cookie">Det er greit!</button>
				  </div>
				</div>
